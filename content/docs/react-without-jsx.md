...
O componente pode ser fornecido como uma string, como uma subclasse de `React.Component`, ou ainda como uma função para componentes que não possuem estado (state).
