...
* Não considere aplicar como uma violação de regra. ([@sophiebits](https://github.com/sophiebits) em [#14040](https://github.com/facebook/react/pull/14040))
...
Se você está utilizando Hooks da versão alpha do React, observe que esta versão contêm algumas pequenas mudanças, que causa instabilidade ao Hooks. **Nós não recomendamos a dependência da versão alpha em código de produção.** Nós publicamos assim que possível, a realização das mudanças em resposta à opinião da comunida, antes da versão estável da API.
