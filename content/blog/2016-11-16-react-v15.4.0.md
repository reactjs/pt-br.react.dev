...
Isso resolve algumas questões de longa data, tais como [erros](https://github.com/facebook/react/issues/7386) quando você importa o React DOM no mesmo arquivo que o [teste snapshot]((https://facebook.github.io/jest/blog/2016/07/27/jest-14.html)) renderizado.
...
Outra coisa a observar é que o React DOM Server agora tem o mesmo tamanho que o React DOM uma vez que ele contém a própria cópia do React reconciler. Nós não recomendamos usando React DOM Server no lado do cliente na maioria dos casos. 
