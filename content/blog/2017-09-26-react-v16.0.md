...
Ao invés de ignorar atributos HTML e SVG não reconhecidos, o React agora [os passará para o DOM](/blog/2017/09/08/dom-attribute-in-react-16.html). Isso nos traz o benefício adicional de nos livrar da maioria da lista de permissões de atributos do React, resultando em tamanhos de arquivo reduzidos.
