...
### Depreciando "Factory" Componentes {#deprecating-factory-components}
...
O `<Profiler>` mede com qual frequência uma aplicação React renderiza e qual o "custo" da renderização. Sua finalidade é ajudar identificar partes de um aplicativo que é lento e podem se beneficiar da [otimização, como a memorização](/docs/hooks-faq.html#how-to-memoize-calculations).
...
> Nota:
>
> Profiling adiciona uma sobrecarga extra, portanto, **ela é desativada no [build de produção](https://reactjs.org/docs/optimizing-performance.html#use-the-production-build)**.
>
...
* Corrige efeitso pendentes de ser liberados muito tarde. ([@acdlite](https://github.com/acdlite) em [#15650](https://github.com/facebook/react/pull/15650))
