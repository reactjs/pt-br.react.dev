...
A renderização de servidor em streaming permite que você gere HTML a partir de componentes React no servidor e envie esse HTML para seus usuários. No React 18, você pode usar o `Suspense` para dividir seu aplicativo em unidades independentes menores que podem ser transmitidas independentemente umas das outras sem bloquear o restante do aplicativo. Isso significa que os usuários verão seu conteúdo mais cedo e poderão começar a interagir com ele muito mais rápido.

Para uma explicação mais detalhada, veja a palestra de [Shaundai Person](https://twitter.com/shaundai) aqui:
...
Para suportar os novos recursos nesta versão, anunciamos também a recém-formada equipe do React DevTools e um novo Profiler de Linha do Tempo para ajudar os desenvolvedores a depurar seus aplicativos React.
...
Olhando um pouco mais para o futuro, [Xuan Huang (黄玄)](https://twitter.com/Huxpro) compartilhou uma atualização de nossa pesquisa de laboratórios React sobre um compilador de auto-memoização. Confira esta palestra para mais informações e uma demonstração do protótipo do compilador:
...
[Rachel Nabors](https://twitter.com/rachelnabors) iniciou uma seção de palestras sobre aprender e projetar com React com uma palestra sobre nosso investimento nos novos docs do React ([agora enviados como react.dev](/blog/2023/03/16/introducing-react-dev)):
...
* Roman Rädle: [Machine Learning em dispositivo para React Native](https://youtu.be/NLj73vrc2I8)
...
A palestra de Pete Hunt na JSConf EU 2013 aborda três tópicos: descartar a noção de templates e construir visualizações com JavaScript, “re-renderizar” toda a sua aplicação quando seus dados mudam e uma implementação leve do DOM e eventos - (2013 - 0h30m).
