...
Quando você aninha conteúdo dentro de uma tag JSX, o componente pai irá recebê-lo dentro de uma prop denominada `children`. Exemplificando, o componente `Card` abaixo receberá a prop `children` definida como `<Avatar />` e o renderizará em uma div a qual o encapsula:
